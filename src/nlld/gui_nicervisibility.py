...
import pandas as pd
import numpy as np
from nlld import targetvisibilitydetails  # your custom module
...
app.layout = html.Div([
    ...
    html.Div([
    html.H1("NICER Visibility Plot with Pagination and Filtering"),
...
def update_plot(prev_clicks, next_clicks, sa_range, sort_field, sources_per_page, selected_targets, current_page):
    ctx = callback_context
    ...
    max_page = max(1, int(np.ceil(len(df_filtered) / sources_per_page)))
